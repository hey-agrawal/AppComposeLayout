package com.example.appcompose.screens2.sheetsBottom
...
@Composable
fun SheetsBottom(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Sheet Bottom", color = Color.Black) }, backgroundColor = Color.White
            )
        ...
        content = {it
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = "Bottom Sheets are surface containing supplementary content that are anchored to the bottom of the screen" ,
                ...
                Spacer(modifier = Modifier.height(8.dp))
                HyperlinkText(fullText = "SourceCode", linkText = listOf("SourceCode") , hyperlinks = listOf("https://github.com/hey-agrawal/BasicCode/blob/main/ModalBottomSheet.kt") )
                Spacer(modifier = Modifier.height(8.dp))
            }
        }
    )

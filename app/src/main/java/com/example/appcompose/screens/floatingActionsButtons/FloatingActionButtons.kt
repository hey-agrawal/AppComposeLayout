...
fun FloatingActionButtons(navController: NavHostController){
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Floating Actions Button", color = Color.Black) }, backgroundColor = Color.White
            )
        ...
        content = {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                HyperlinkText(fullText = "SourceCode", linkText = listOf("SourceCode") , hyperlinks = listOf("https://github.com/hey-agrawal/BasicCode/blob/main/FABWithIcon.kt") )
                Spacer(modifier = Modifier.height(8.dp))
                CardItem2(title = "Fluid Extended Fab",route = Destination.FluidExtendedFab.route,navController)
                Spacer(modifier = Modifier.height(8.dp))
                HyperlinkText(fullText = "SourceCode", linkText = listOf("SourceCode") , hyperlinks = listOf("https://github.com/hey-agrawal/BasicCode/blob/main/FluidFAB.kt") )
            }
        }
    )
}